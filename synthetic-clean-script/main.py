...
parser.add_argument('--n_rct', default=2000, type=int)
parser.add_argument('--n_obs', default=2000, type=int)
...
res_keys = ["SE_Y0", "SE_Y1", "SE_A", "SE_S", "SE_R"]
...
for d in ds:
    ...
    save_dir = Path(os.path.dirname(os.path.abspath(__file__)) + f"/results/d{d}/{args.bias_type}")
